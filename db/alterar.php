...
if (count($_POST) > 0) {
    ...
    //Verifica se existe erros e prepara para inserir no banco
    if (!count($erros)) {
...
<!--
    - Ao percorrer o array foi aplicado a classe de alerta do bootstrap 4 
    no início do formulário. Essa é uma opção, a segunda é a que esta aplicada
...
<form action="#" method="post">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control <?= $erros['nascimento'] ? 'is-invalid' : '' ?>" id="nascimento" name="nascimento" placeholder="Nascimemento" value="<?= $dados['nascimento'] ?>">
            <div class="invalid-feedback">
                <?= $erros['nascimento'] ?>
            </div>
        </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control <?= $erros['filhos'] ? 'is-invalid' : '' ?>" id="filhos" name="filhos" placeholder="Quantidade filhos" value="<?= $dados['filhos'] ?>">
            <div class="invalid-feedback">
                <?= $erros['filhos'] ?>
            </div>
        </div>
